...
// name of new component Form:
export default function ReserveForm({ create = false }) {
  ...
  // this loads the data for the specific reservation onto the form if CREATE = FALSE
